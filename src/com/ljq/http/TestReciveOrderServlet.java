...
public class TestReciveOrderServlet extends HttpServlet {
    private static Log log= LogFactory.getLog(TestReciveOrderServlet.class);
    ...
    public void doPost(HttpServletRequest req,HttpServletResponse rep) throws ServletException{
        int orderType=Integer.parseInt(req.getParameter("orderTypeTest"));
        String dataFilePath=req.getParameter("dataFilePathTest");
